...
import {
  IComponentCollaborator,
  IComponentCollaboratorConduct,
  IComponentCollaboratorDetail,
} from '../interfaces/component-collaborator.interface';
...
export class ComponentCollaboratorEvaluateBuilderService {
  ...
  public buildComponentCollaboratorEvaluateForm(
    data: IComponentCollaborator | null,
    componentId: number
  ): FormGroup {
  ...
  public buildComponentCollaboratorDetailEvaluateForm(
    detail: IComponentCollaboratorDetail,
    isValidate = true
  ): FormGroup {
    return this._fb.group({
      id: [detail.id],
  ...
  public buildComponentCollaboratorConductEvaluateForm(
    detail: IComponentCollaboratorConduct
  ): FormGroup {
    return this._fb.group({
      id: [detail.id],
