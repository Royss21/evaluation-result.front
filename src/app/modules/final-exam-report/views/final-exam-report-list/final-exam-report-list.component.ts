...
export class FinalExamReportListComponent {
  ...
  private _getEvaluationsFinished(): void {
    this._evaluationService
      .getAllFinished()
      .subscribe((evaluations: IEvaluationFinished[]) => {
  ...
  private callPaginated(): void {
    this.paginated$.subscribe((paginatedFilter: IFinalExamPaginatedFilter) => {
      if (paginatedFilter) {
        ...
        this._reportService
          .getFinalExamPaginated(this.paginatedFilterCurrent)
          .subscribe((paginated) => {
